...
public class ApnSettings extends RestrictedSettingsFragment implements
    ...
    // SPRD: add for bug709944
    private ProgressDialog mDialog;
    // SPRD: add for bug709449
    ...
    private void fillList() {
        ...
        final int subId = mSubscriptionInfo != null ? mSubscriptionInfo.getSubscriptionId()
                : SubscriptionManager.INVALID_SUBSCRIPTION_ID;
         // SPRD: Bug 594919 set default APN
        ...
        Cursor cursor = getContentResolver().query(Telephony.Carriers.CONTENT_URI, new String[] {
                ...
                null, orderBy); // SPRD: Bug 594919 set default APN
        ...
        if (cursor != null) {
            ...
            while (!cursor.isAfterLast()) {
                ...
                /* SPRD: Add for 588412 show the IMS Apn on Volte version. @{ */
                boolean isApnVisible = ApnSettingsPluginsUtils.getInstance(
                        getActivity()).apnSettingVisibility(mccmnc, type);
                if (isApnVisible) {
            ...
            for (Preference preference : mnoApnList) {
                ...
                if (mSelectedKey == null && apnPref.getSelectable()) {
                    String apn = apnPref.getSummary().toString();
                    boolean isNeedSetChecked = ApnSettingsPluginsUtils
                            .getInstance(getActivity()).getIsNeedSetChecked(
                                    mccmnc, apn);
                    if (isNeedSetChecked) {
                        apnPref.setChecked();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case MENU_RESTORE:
            /* SPRD: add for bug709436 & 709449 & 712175 @{ */
            if (getActivity() != null) {
                /* SPRD: add for bug709436 @{ */
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case EVENT_RESTORE_DEFAULTAPN_COMPLETE:
                    ...
                    Intent sentIntent = new Intent(activity.getApplicationContext(), APNAdapteActivity.class);
